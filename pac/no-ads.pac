...
//
var noadsver = "$Id: no-ads.pac,v 5.107 2013/06/04 19:19:08 loverso Exp loverso $";
...
var re_banner_white = /(load|feature=banner|upload_popup|popupplayer|popupmenu\.css|loginpopup|bannerbomb|popup\.lala\.com\/)/i;
...
var re_adhost = /\b((new)?ad(?!(vantage|am|mission|visor|alur|iumx|ult|vizia|obe|min|sl|d|olly|vance))|ads\b|adserv|pop(?!ular|corn|e)|click(?!redblue|andbuy|.reference)|cash(?!back)|banner|bans)/i;
...
function FindProxyForURL(url, host)
{
	...
	|| (host == "web.lightningcast.net")	// I forgot why I added this
